...
Rails.application.configure do
  ...
  # Solid Queue in dev too — jobs survive a server restart (async would
  # drop in-flight turns), and the recurring scheduler (routines, stalled
  # turn reaping) only runs under the bin/jobs supervisor.
